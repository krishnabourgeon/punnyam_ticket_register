...
// //   // TODO: the vazhivad/pooja table below still has no real data source for
// //   // a selected counter — wire it to the correct backend endpoint once
// //   // available. Rows are intentionally left empty until then.
...
// //       // TODO: no confirmed backend endpoint yet for vazhivad/pooja entries
// //       // by counter + date. Leaving rows empty until that's wired up.
// //       _rows = [];
// //     });
// //   }
...
// //           ),
// //           content: Text(
// //             'Book closed for ${_selectedCounter?.name ?? ''}',
